...
int main(int argc, const char * argv[]) {
  ...
  key_val_map[120] = string("R");
  key_val_map[121] = string("R");
  key_val_map[122] = string("R");
  key_val_map[123] = string("R");
  key_val_map[124] = string("R");
  key_val_map[125] = string("R");
  key_val_map[126] = string("R");
  key_val_map[127] = string("R");
  key_val_map[128] = string("R");
  key_val_map[129] = string("R");
  key_val_map[130] = string("R");
  key_val_map[131] = string("R");
  key_val_map[132] = string("R");
  key_val_map[133] = string("R");
  key_val_map[134] = string("R");
  key_val_map[135] = string("R");
  key_val_map[136] = string("R");
  key_val_map[137] = string("R");
  key_val_map[138] = string("R");
  ...
  if(tCaseNum & CASE_NUM_0) {
    ...
    printf("=> Key Tree:\n");bptree.printKeys();//输出关键字
    printf("=> Value Tree:\n");bptree.printValues();//输出数据

    bptree.insert(2, key_val_map[2]);//插入bptree::insert(int key, string &_value)
